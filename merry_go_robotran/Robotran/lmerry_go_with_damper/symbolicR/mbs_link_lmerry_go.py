...
# Link anchor points Kinematics
    ...
    Plnk22 = s.dpt[2,2]-s.dpt[2,6]
    Plnk32 = s.dpt[3,2]-s.dpt[3,6]
    ...
    Plnk33 = RLlnk6_32-s.dpt[3,7]
    PPlnk3 = Plnk13*Plnk13+Plnk33*Plnk33
    Z3 = sqrt(PPlnk3)
    e13 = Plnk13/Z3
    e33 = Plnk33/Z3
    Zd3 = ORlnk6_12*e13+ORlnk6_32*e33
    RLlnk8_12 = s.dpt[1,19]*C13+s.dpt[3,19]*S13
    RLlnk8_32 = -s.dpt[1,19]*S13+s.dpt[3,19]*C13
    POlnk8_32 = RLlnk8_32+s.dpt[3,4]
    ORlnk8_12 = qd[13]*RLlnk8_32
    ORlnk8_32 = -qd[13]*RLlnk8_12
    Plnk24 = s.dpt[2,4]-s.dpt[2,8]
    Plnk34 = POlnk8_32-s.dpt[3,8]
    PPlnk4 = Plnk24*Plnk24+Plnk34*Plnk34+RLlnk8_12*RLlnk8_12
    Z4 = sqrt(PPlnk4)
    e14 = RLlnk8_12/Z4
    e24 = Plnk24/Z4
    e34 = Plnk34/Z4
    Zd4 = ORlnk8_12*e14+ORlnk8_32*e34
...
# Link Dynamics: forces projection on body-fixed frames
    ...
    fSlnk12 = -Flink2*e32*S7
    fSlnk22 = Flink2*e22
    fSlnk32 = Flink2*e32*C7
    trqlnk7_2_1 = -fSlnk22*s.l[3,7]
    trqlnk7_2_2 = fSlnk12*s.l[3,7]
    fPlnk13 = Flink3*e13
    fPlnk33 = Flink3*e33
    ...
    fPlnk24 = Flink4*e24
    fPlnk34 = Flink4*e34
    frclnk3_4_1 = fPlnk14+frclnk3_3_1
    ...
    trqlnk3_4_2 = trqlnk3_3_2+fPlnk14*(s.dpt[3,8]-s.l[3,3])
    trqlnk3_4_3 = -fPlnk14*s.dpt[2,8]
    fSlnk14 = Flink4*(e14*C13-e34*S13)
    fSlnk24 = Flink4*e24
    fSlnk34 = Flink4*(e14*S13+e34*C13)
    trqlnk13_4_1 = fSlnk24*(s.dpt[3,19]-s.l[3,13])
    trqlnk13_4_2 = -fSlnk14*(s.dpt[3,19]-s.l[3,13])+fSlnk34*s.dpt[1,19]
    trqlnk13_4_3 = -fSlnk24*s.dpt[1,19]
 
# Symbolic model output

    frc[1,3] = s.frc[1,3]+frclnk3_4_1
    frc[2,3] = s.frc[2,3]+frclnk3_4_2
    frc[3,3] = s.frc[3,3]+frclnk3_4_3
    trq[1,3] = s.trq[1,3]+trqlnk3_4_1
    trq[2,3] = s.trq[2,3]+trqlnk3_4_2
    trq[3,3] = s.trq[3,3]+trqlnk3_4_3
    frc[1,4] = s.frc[1,4]-fSlnk11
    frc[3,4] = s.frc[3,4]-fSlnk31
    trq[2,4] = s.trq[2,4]+trqlnk4_1_2
    frc[1,7] = s.frc[1,7]-fSlnk12
    frc[2,7] = s.frc[2,7]-fSlnk22
    frc[3,7] = s.frc[3,7]-fSlnk32
    trq[1,7] = s.trq[1,7]+trqlnk7_2_1
    trq[2,7] = s.trq[2,7]+trqlnk7_2_2
    frc[1,10] = s.frc[1,10]-fSlnk13
    frc[3,10] = s.frc[3,10]-fSlnk33
    trq[2,10] = s.trq[2,10]+trqlnk10_3_2
    frc[1,13] = s.frc[1,13]-fSlnk14
    frc[2,13] = s.frc[2,13]-fSlnk24
    frc[3,13] = s.frc[3,13]-fSlnk34
    trq[1,13] = s.trq[1,13]+trqlnk13_4_1
    trq[2,13] = s.trq[2,13]+trqlnk13_4_2
    trq[3,13] = s.trq[3,13]+trqlnk13_4_3
